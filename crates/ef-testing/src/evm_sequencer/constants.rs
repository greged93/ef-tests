...
lazy_static! {
    ...
    pub static ref RELAYER_BALANCE: StarkFelt = StarkFelt::from(1_000_000_000_000_000_000_000_000u128);
}
...
lazy_static! {
    ...
    pub static ref OPENZEPPELIN_ACCOUNT_CLASS: LegacyContractClass = load_contract_class("../../build/v0/openzeppelin_account.json").expect("Failed to load openzeppelin account contract class");
